...
| Windows-Ollama SoM Tier-2 integration — Phase 1 (Sprint 1) | 2026-04-15 | Issue [#113](https://github.com/NIBARGERB-HLDPRO/hldpro-governance/issues/113). PR #112 merged with Stage A documentation. Invariants 8–10 declared (PII floor, firewall binding, audit trail). Rung documented/disabled until Sprint 5. Three exceptions cover PII middleware (Sprint 2), audit trail (Sprints 3–4), and activation gate (Sprint 5). Closeout: `raw/closeouts/2026-04-15-windows-ollama-stage-a.md`, wiki: `wiki/decisions/2026-04-15-windows-ollama-stage-a.md`. |
| Windows-Ollama SoM Tier-2 integration — Phase 2 (Sprint 2) | 2026-04-15 | Issue [#115](https://github.com/NIBARGERB-HLDPRO/hldpro-governance/issues/115). PR #116 merged (commit 9d3061d). Delivered submit.py (PII middleware, model allowlist, failover rules), pii_patterns.yml, model_allowlist.yml, test_submit.py (16 tests, 100% pass). Cross-review (gpt-5.4 APPROVED), gate (gpt-5.4 PASS). Closeout: `raw/closeouts/2026-04-15-windows-ollama-sprint2.md`, wiki: `wiki/decisions/2026-04-15-windows-ollama-sprint2.md`. Next: Sprint 3 (audit writer). |
