...
|------|----------|-----------|-------|
| Living Knowledge Base — Phase 6.5: Neo4j runtime bootstrap | LOW | 1-2 | Issue [#62](https://github.com/NIBARGERB-HLDPRO/hldpro-governance/issues/62). Bootstrap and document a local Neo4j runtime so the graph push path has a real target before issue `#48` is resumed. |
