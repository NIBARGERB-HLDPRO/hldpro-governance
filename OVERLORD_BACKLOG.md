...
|------|----------|-----------|-------|
| Shared dependency symlink pattern for clean worktrees | MEDIUM | 1-2 | Issue [#70](https://github.com/NIBARGERB-HLDPRO/hldpro-governance/issues/70). Review whether borrowing installed dependencies from a root checkout into isolated worktrees via symlinks is documented, approved, and safely wired. |
