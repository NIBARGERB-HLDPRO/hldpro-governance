...
| `python3 tools/local-ci-gate/bin/hldpro-local-ci run --profile hldpro-governance --json` | PASS | Local CI Gate passed on the merge-resolved branch tip with report dir `cache/local-ci-gate/reports/20260430T122820Z-hldpro-governance-git`. |
