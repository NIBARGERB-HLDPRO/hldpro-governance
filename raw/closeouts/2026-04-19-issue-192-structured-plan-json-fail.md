...
Post-closeout Local CI initially caught that `wiki/index.md` was generated by Stage 6 but missing from the execution-scope allowlist; the scope now explicitly includes it and Local CI Gate passes.
