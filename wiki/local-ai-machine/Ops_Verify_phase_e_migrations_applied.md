# Ops Verify phase e migrations applied
...
- **_database_url()** (4 connections) — `local-ai-machine/scripts/ops/verify_phase_e_migrations_applied.py`
- **_load_env_file()** (3 connections) — `local-ai-machine/scripts/ops/verify_phase_e_migrations_applied.py`
