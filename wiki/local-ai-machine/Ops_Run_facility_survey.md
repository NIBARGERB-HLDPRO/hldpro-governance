...
- **Load and filter VLM findings from router JSON files.      Returns (filtered_find** (1 connections) — `local-ai-machine/scripts/ops/run_facility_e2e_survey.py`
- **Return existing visit_id from state or create a new one.** (1 connections) — `local-ai-machine/scripts/ops/run_facility_e2e_survey.py`
- **Start a survey session. Returns survey_id.** (1 connections) — `local-ai-machine/scripts/ops/run_facility_e2e_survey.py`
- **Submit a single finding to the survey API.** (1 connections) — `local-ai-machine/scripts/ops/run_facility_e2e_survey.py`
...
- `local-ai-machine/scripts/ops/run_facility_e2e_survey.py`
