# Ops Run gui visual loop runtime
...
- **rejected_verdict()** (3 connections) — `local-ai-machine/scripts/ops/test_run_frontend_gui_visual_loop_runtime.py`
- **_build_test_png()** (2 connections) — `local-ai-machine/scripts/ops/test_run_frontend_gui_visual_loop_runtime.py`
- **fail()** (2 connections) — `local-ai-machine/scripts/ops/test_run_frontend_gui_visual_loop_runtime.py`
- **Build a minimal valid PNG >10KB for blank-guard compatibility.** (1 connections) — `local-ai-machine/scripts/ops/test_run_frontend_gui_visual_loop_runtime.py`
...
- `local-ai-machine/scripts/ops/test_run_frontend_gui_visual_loop_runtime.py`
