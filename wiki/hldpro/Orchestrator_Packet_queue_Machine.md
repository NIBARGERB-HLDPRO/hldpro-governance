...
- **main()** (20 connections) — `hldpro-governance/repos/local-ai-machine/scripts/ops/run_frontend_gui_visual_loop.py`
- **packet_queue.py** (19 connections) — `hldpro-governance/scripts/orchestrator/packet_queue.py`
- **run_frontend_gui_visual_loop.py** (16 connections) — `hldpro-governance/repos/local-ai-machine/scripts/ops/run_frontend_gui_visual_loop.py`
- **_packet()** (16 connections) — `hldpro-governance/scripts/orchestrator/test_packet_queue.py`
...
- **_load_scope()** (12 connections) — `hldpro-governance/scripts/overlord/assert_execution_scope.py`
- **check_route()** (12 connections) — `hldpro-governance/scripts/overlord/check_worker_handoff_route.py`
- **audit_branch_residue.py** (12 connections) — `hldpro-governance/repos/local-ai-machine/scripts/ops/audit_branch_residue.py`
...
- `hldpro-governance/repos/ASC-Evaluator/Reviews/Cycle_1_MHSC_Richmond_20250513/scripts/extract_xlsx_images.py`
- `hldpro-governance/repos/Stampede/scripts/emit_yfinance_candidate_template.py`
- `hldpro-governance/repos/Stampede/scripts/validate_phase0_lookback_candidate_freshness.py`
- `hldpro-governance/repos/local-ai-machine/scripts/ops/append_learning_record.py`
- `hldpro-governance/repos/local-ai-machine/scripts/ops/audit_branch_residue.py`
- `hldpro-governance/repos/local-ai-machine/scripts/ops/build_delegated_execution_envelope.py`
- `hldpro-governance/repos/local-ai-machine/scripts/ops/build_frontend_gui_repair_request.py`
- `hldpro-governance/repos/local-ai-machine/scripts/ops/build_scavenger_teardown_status.py`
...
- `hldpro-governance/repos/local-ai-machine/scripts/ops/promote_lint_rule_bundle.py`
