...
- **validate_schema()** (6 connections) — `scripts/pages-deploy/pages_deploy_gate.py`
...
- **_check_pages_limits()** (5 connections) — `scripts/pages-deploy/pages_deploy_gate.py`
...
- **validate_config()** (4 connections) — `scripts/pages-deploy/pages_deploy_gate.py`
