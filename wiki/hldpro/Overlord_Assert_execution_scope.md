...
- **assert_execution_scope.py** (22 connections) — `scripts/overlord/assert_execution_scope.py`
- **check_scope()** (11 connections) — `scripts/overlord/assert_execution_scope.py`
...
- **_load_scope()** (5 connections) — `scripts/overlord/assert_execution_scope.py`
...
- **_model_family()** (2 connections) — `scripts/overlord/assert_execution_scope.py`
- **_parse_iso8601_timestamp()** (2 connections) — `scripts/overlord/assert_execution_scope.py`
- **_path_allowed()** (2 connections) — `scripts/overlord/assert_execution_scope.py`
- **_resolve_expected_execution_root()** (2 connections) — `scripts/overlord/assert_execution_scope.py`
- **_validate_active_exception_ref()** (2 connections) — `scripts/overlord/assert_execution_scope.py`
