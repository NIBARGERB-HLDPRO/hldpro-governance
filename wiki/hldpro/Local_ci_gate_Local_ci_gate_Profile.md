...
- **.test_ai_integration_services_profile_scopes_app_builds()** (1 connections) — `tools/local-ci-gate/tests/test_local_ci_gate.py`
- **.test_base_ref_changed_files_include_unstaged_tracked_edits()** (1 connections) — `tools/local-ci-gate/tests/test_local_ci_gate.py`
- **.test_blocker_and_advisory_statuses_are_distinct()** (1 connections) — `tools/local-ci-gate/tests/test_local_ci_gate.py`
- **.test_bundled_profiles_load()** (1 connections) — `tools/local-ci-gate/tests/test_local_ci_gate.py`
- **.test_changed_files_file_accepts_null_separated_entries()** (1 connections) — `tools/local-ci-gate/tests/test_local_ci_gate.py`
