...
- **validate_structured_agent_cycle_plan.py** (12 connections) — `scripts/overlord/validate_structured_agent_cycle_plan.py`
...
- **_load_json()** (3 connections) — `scripts/overlord/validate_structured_agent_cycle_plan.py`
- **_matching_plan_payloads()** (3 connections) — `scripts/overlord/validate_structured_agent_cycle_plan.py`
