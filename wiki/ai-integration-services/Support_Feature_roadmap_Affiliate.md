...
- **fireCallbackCall()** (6 connections) — `ai-integration-services/backend/supabase/functions/capacity-watcher/index.ts`
...
- **buildDay1Prompt()** (5 connections) — `ai-integration-services/backend/supabase/functions/onboarding-call-dialer/index.ts`
