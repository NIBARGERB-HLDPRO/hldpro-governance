...
- **DebugFeedbackOverlay.tsx** (8 connections) — `ai-integration-services/apps/reseller/src/components/debug/DebugFeedbackOverlay.tsx`
...
- **DashboardIntegrations.tsx** (8 connections) — `ai-integration-services/var/worktrees/issue-1211-sweep-claude-supervisor/apps/portal/src/pages/dashboard/DashboardIntegrations.tsx`
- **DebugFeedbackOverlay.tsx** (8 connections) — `ai-integration-services/var/worktrees/issue-1211-sweep-claude-supervisor/apps/reseller/src/components/debug/DebugFeedbackOverlay.tsx`
- **handleCancel()** (7 connections) — `ai-integration-services/apps/marketing/src/portal/pages/dashboard/DashboardAddons.tsx`
...
- `ai-integration-services/apps/marketing/src/components/debug/DebugFeedbackOverlay.tsx`
