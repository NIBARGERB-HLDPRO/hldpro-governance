...
- **useClients()** (2 connections) — `ai-integration-services/apps/dashboard/src/lib/api/clients.ts`
...
- `ai-integration-services/var/worktrees/issue-1211-sweep-claude-supervisor/apps/dashboard/src/lib/api/clients.ts`
