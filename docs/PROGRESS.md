...
| Org inventory drift detector | #309 | IN PROGRESS | HIGH | 1-2 | Fixture/live GitHub org inventory drift checker, sweep warn-only reporting, final live detector proof | Child of #298; implementation package at docs/plans/issue-309-structured-agent-cycle-plan.json |
