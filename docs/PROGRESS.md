...
| Governed repo classification schema | #310 | IN PROGRESS | HIGH | 1-2 | Schema-enforced lifecycle/governance classification fields, registry validator coverage, final e2e proof | Child of #298; implementation package at docs/plans/issue-310-structured-agent-cycle-plan.json |
