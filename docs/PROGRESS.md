...
| Org-level Local CI Gate toolkit | #253 | IN REVIEW | HIGH | 4-6 | Reusable runner, governance profile, managed shim deployer, runbook, tests | Implements the planning package from PR #256; consumer rollout remains separate issue-backed work |
