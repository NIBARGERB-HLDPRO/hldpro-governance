...
| seek-and-ponder governance intake | #311 | IN PROGRESS | HIGH | 1-2 | Registry coverage, graph/wiki artifacts, branch/ruleset/check evidence, downstream follow-up issue | Child of #298; implementation package at docs/plans/issue-311-structured-agent-cycle-plan.json |
