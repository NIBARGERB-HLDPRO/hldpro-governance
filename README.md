...
- [`scripts/knowledge_base/log_graphify_usage.py`](scripts/knowledge_base/log_graphify_usage.py) appends schema-shaped usage events to `metrics/graphify-usage/events/`.
