...
## Summary
- 101 nodes · 184 edges · 11 communities detected
...
### Community 8 - "Generate existing info report"
Cohesion: 0.33
...
Cohesion: 0.4
Nodes (6): collect_report_strings(), executive_summary_text(), grouped_counts(), risk_from_score(), top_risk_items(), write_md()

### Community 10 - "Extract xlsx images"
Cohesion: 1.0
...
- **Why does `add_heading()` connect `Generate existing info report Reviews` to `Generate existing info report`, `Generate docx from markdown Cycle`?**
