...
## Corpus Check
- Large corpus: 2077 files · ~2,706,771 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 3502 nodes · 8556 edges · 349 communities detected
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 983 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Community Hubs (Navigation)
- [[_COMMUNITY_Outreach dispatcher Supabase|Outreach dispatcher Supabase]]
...
- [[_COMMUNITY_Addon lifecycle Supabase|Addon lifecycle Supabase]]
...
- [[_COMMUNITY_Real enrollment founder Operator|Real enrollment founder Operator]]
...
### Community 0 - "Outreach dispatcher Supabase"
Cohesion: 0.02
Nodes (80): getApiKey(), sendEmail(), computeSha256(), hashPdfFromUrl(), isExcludedDocumentType(), getServiceConnector(), addMinutes(), applyFieldMapping() (+72 more)

### Community 1 - "Auth Supabase"
Cohesion: 0.02
Nodes (65): decodeJwtPayload(), getProjectRefFromSupabaseUrl(), getSupabaseClient(), getUserFromAuthRest(), hasServiceRoleClaimsForProject(), isVerifiedServiceRoleJwtForProject(), resolveAuthContext(), getModelTier() (+57 more)

### Community 2 - "Vapi client Supabase"
Cohesion: 0.02
Nodes (106): handleSubmit(), analyticsInsert(), analyticsSelect(), analyticsUpdate(), analyticsUpsert(), buildHeaders(), buildUrl(), csvEscape() (+98 more)

### Community 3 - "Operator client decommission Supabase"
Cohesion: 0.02
Nodes (134): createExperiment(), fetchExperiments(), updateExperimentStatus(), updateTrafficPct(), advanceSigningWorkflow(), emitAuditLog(), getSupabaseServiceClient(), readCalcomResponseValue() (+126 more)

### Community 4 - "Addon lifecycle Supabase"
Cohesion: 0.02
Nodes (81): accountForAddon(), activateAddon(), assertBackendArtifact(), callFunction(), cancelAddonFromUi(), cleanupAddonState(), ensureEnvironment(), escapeRegex() (+73 more)

### Community 5 - "Setup readiness Supabase"
Cohesion: 0.03
Nodes (101): CalcomClient, toCalcomApiBookingFields(), buildCalcomBookingLink(), buildCalcomFinalizeDefaults(), buildServiceAppointmentBookingFields(), normalizeAvailability(), normalizeDuration(), normalizeTimeZone() (+93 more)

### Community 6 - "Integrations Sign"
Cohesion: 0.03
Nodes (77): callEdgeFunction(), getStageIndex(), handleApprove(), handleCancel(), handleExecute(), handleNewBooking(), PipelineProgressBar(), costItemBadge() (+69 more)

### Community 7 - "Support Feature roadmap Affiliate"
Cohesion: 0.03
Nodes (84): formatCents(), formatDate(), loadConversions(), formatCents(), formatDate(), initiateStripeConnect(), loadPayoutData(), saveThreshold() (+76 more)

### Community 8 - "Enrich site Supabase"
Cohesion: 0.03
Nodes (89): buildMatchingPrompt(), callClaudeForMatching(), getReconciliationAction(), matchTransactions(), parseAndValidateMatches(), assembleOverview(), extractSection(), readFile() (+81 more)

### Community 9 - "Real enrollment founder Operator"
Cohesion: 0.04
Nodes (77): openReferrals(), main(), openNewTicket(), openSupport(), browserSignIn(), callEdgeFunction(), callEdgeFunctionMethod(), cleanupClientByEmail() (+69 more)
...
Cohesion: 0.09
Nodes (39): getAllowedOrigins(), getCorsHeaders(), getSecurityHeaders(), handleCors(), safeErrorResponse(), safeHeaders(), buildLamPayload(), createTrialCoupon() (+31 more)
...
Cohesion: 0.25
Nodes (15): append_jsonl(), AttemptResult, build_command(), event_paths(), kill_group(), main(), parse_args(), session_id() (+7 more)
...
### Community 34 - "Stripe webhook Demo conversion Supabase"
Cohesion: 0.26
...
### Community 36 - "Clients Clients Supabase"
Cohesion: 0.23
...
### Community 37 - "Operator clients interactions"
Cohesion: 0.25
...
### Community 40 - "Roof report Supabase"
Cohesion: 0.33
...
### Community 42 - "Magic link intake"
Cohesion: 0.39
...
### Community 43 - "Stripe webhook Lifecycle Supabase"
Cohesion: 0.29
...
### Community 44 - "Estimate builder Line"
Cohesion: 0.55
...
### Community 50 - "Client signal scorer Supabase"
Cohesion: 0.39
...
### Community 51 - "Solar savings Supabase"
Cohesion: 0.42
...
### Community 52 - "Solar financing options Supabase"
Cohesion: 0.44
...
### Community 53 - "Hvac serial decode Supabase"
Cohesion: 0.53
...
### Community 56 - "Operator client detail expanded"
Cohesion: 0.33
...
### Community 76 - "Operator demo lifecycle"
Cohesion: 0.38
...
### Community 92 - "Sections Value stack"
Cohesion: 0.6
Nodes (4): Check(), Dash(), planSavings(), planTotal()

### Community 93 - "Clients Chief of staff tab"
Cohesion: 0.53
Nodes (4): ChiefOfStaffTab(), formatCents(), handleEdit(), handleSave()

### Community 94 - "Cogs Cogsclient detail"
Cohesion: 0.47
...
### Community 106 - "Flow diagram Connector"
Cohesion: 0.6
Nodes (3): Connector(), FlowDiagram(), MobileConnector()

### Community 107 - "Vapi owner Supabase"
Cohesion: 0.67
...
### Community 110 - "Billing Reseller"
Cohesion: 0.67
...
### Community 116 - "Seam contracts Auth"
Cohesion: 0.67
Nodes (2): authHeaders(), parseJson()

### Community 117 - "Reseller Reseller roi Calculate"
Cohesion: 0.67
Nodes (2): calculateResellerROI(), formatDollars()

### Community 118 - "Brand settings Reseller"
Cohesion: 0.67
Nodes (2): handleSave(), update()

### Community 119 - "Affiliate program Reseller"
Cohesion: 0.67
...
### Community 121 - "Api Testing Use"
Cohesion: 0.67
Nodes (2): useClientHealth(), useTestResults()

### Community 122 - "Provisioning Provisioning monitor Step"
Cohesion: 0.67
Nodes (2): StepRow(), wizardProgress()

### Community 123 - "Workflows Workflow status"
Cohesion: 0.67
Nodes (2): timeAgo(), useWorkflowStatus()

### Community 124 - "Prompts Prompt editor"
Cohesion: 0.67
Nodes (2): clsx(), handleSave()

### Community 125 - "Analytics Abtest manager"
Cohesion: 0.67
...
- **Why does `trim()` connect `Enrich site Supabase` to `Outreach dispatcher Supabase`, `Auth Supabase`, `Vapi client Supabase`, `Operator client decommission Supabase`, `Addon lifecycle Supabase`, `Setup readiness Supabase`, `Integrations Sign`, `Support Feature roadmap Affiliate`, `Real enrollment founder Operator`, `Provisioning Autoprovision preflight Client`, `Magic link review decision Supabase`, `Magic link jwt Supabase`, `Wizard Assistant`, `Compendium Extract Claude`, `Addon provision Seed`, `Clients Client detail`, `Brain Handle`, `Assistant chat Widget`, `Gc Gcsub Line`, `Operator clients interactions`, `Debug Debug feedback overlay`, `Roof report Supabase`, `Magic link intake`, `Operator client detail expanded`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `toLocaleDateString()` connect `Support Feature roadmap Affiliate` to `Auth Supabase`, `Gc Gcsub Line`, `Addon lifecycle Supabase`, `Integrations Sign`, `Roof report Supabase`, `Enrich site Supabase`, `Auth Reseller`, `Provisioning Autoprovision preflight Client`, `Cogs export generator Supabase`, `Wizard Assistant`, `Addon provision Seed`, `Finance Brain`, `Clients Client detail`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `update()` connect `Operator client decommission Supabase` to `Auth Supabase`, `Stripe webhook Demo conversion Supabase`, `Vapi client Supabase`, `Addon lifecycle Supabase`, `Setup readiness Supabase`, `Integrations Sign`, `Support Feature roadmap Affiliate`, `Clients Clients Supabase`, `Stripe webhook Lifecycle Supabase`, `Cogs export generator Supabase`, `Wizard Assistant`, `Addon provision Seed`, `Connectors Crm Ghl`, `Connectors Crm Local`, `Brain Handle`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Are the 100 inferred relationships involving `trim()` (e.g. with `normalizePhone()` and `sha256Hash()`) actually correct?**
  _`trim()` has 100 INFERRED edges - model-reasoned connections that need verification._
- **Are the 101 inferred relationships involving `text()` (e.g. with `sendReminderSMS()` and `sendSms()`) actually correct?**
  _`text()` has 101 INFERRED edges - model-reasoned connections that need verification._
