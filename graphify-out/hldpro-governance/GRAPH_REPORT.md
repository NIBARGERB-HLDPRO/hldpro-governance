...
## Corpus Check
- Large corpus: 1696 files · ~428,276 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1234 nodes · 2364 edges · 63 communities detected
- Extraction: 50% EXTRACTED · 50% INFERRED · 0% AMBIGUOUS · INFERRED: 1174 edges (avg confidence: 0.5)
...
### Community 28 - "Overlord Deploy local ci gate"
Cohesion: 0.27
...
### Community 34 - "Overlord Validate structured agent cycle plan"
Cohesion: 0.31
...
### Community 35 - "Overlord Validate governed repos"
Cohesion: 0.26
Nodes (1): GovernedReposValidationTests

### Community 36 - "Lam Runtime inventory"
Cohesion: 0.15
...
### Community 38 - "Overlord Pentagi sweep"
Cohesion: 0.42
...
### Community 39 - "Knowledge base Graph"
Cohesion: 0.38
...
### Community 40 - "Orchestrator Delegation Owned"
Cohesion: 0.45
...
### Community 41 - "Orchestrator Hitl relay queue"
Cohesion: 0.45
...
### Community 42 - "Overlord Validate backlog gh sync"
Cohesion: 0.29
...
### Community 43 - "Overlord Validate registry surfaces"
Cohesion: 0.49
...
### Community 53 - "Knowledge base Log graphify usage"
Cohesion: 0.7
Nodes (4): append_event(), build_event(), main(), parse_args()

### Community 54 - "Packet Hitl relay schema"
Cohesion: 0.8
Nodes (4): _load(), test_invalid_hitl_relay_examples_fail(), test_valid_hitl_relay_examples_pass(), _validator()

### Community 55 - "Knowledge base Graphify governance"
Cohesion: 0.83
Nodes (3): check(), is_ignored(), main()

### Community 56 - "Knowledge base Update knowledge"
Cohesion: 0.83
Nodes (3): main(), replace_section(), summary_line()

### Community 57 - "Packet Emit Yaml"
Cohesion: 0.67
Nodes (3): emit_packet(), main(), Emit a packet YAML file.     Returns: path to written file

### Community 58 - "Overlord Render github issue feed"
Cohesion: 1.0
Nodes (2): main(), render_issue()

### Community 59 - "Knowledge base Push graph to neo4j"
Cohesion: 1.0
Nodes (2): build_scoped_graph(), main()

### Community 60 - "Windows ollama Init"
Cohesion: 1.0
Nodes (0): 

### Community 61 - "Windows ollama Submit Temporary"
Cohesion: 1.0
