...
## Corpus Check
- Large corpus: 3398 files · ~700,136 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1999 nodes · 4037 edges · 98 communities detected
- Extraction: 48% EXTRACTED · 52% INFERRED · 0% AMBIGUOUS · INFERRED: 2111 edges (avg confidence: 0.5)
...
5. `TestGovernanceSurfacePlanGate` - 29 edges
...
### Community 3 - "Som client Som client Deploy"
Cohesion: 0.07
...
### Community 7 - "Overlord Validate handoff package Closeout"
Cohesion: 0.1
...
### Community 13 - "Deploy Deploy gate Run"
Cohesion: 0.13
...
### Community 24 - "Overlord Validate structured agent cycle plan"
Cohesion: 0.13
...
### Community 34 - "Deploy Deploy verifier Title"
Cohesion: 0.27
...
### Community 36 - "Remote mcp Operator connectivity"
Cohesion: 0.16
...
### Community 39 - "Overlord Deploy governance tooling"
Cohesion: 0.32
Nodes (1): TestDeployGovernanceTooling

### Community 40 - "Overlord Check overlord backlog github alignment"
Cohesion: 0.14
...
Cohesion: 0.27
Nodes (16): _branch_issue_number(), _display_path(), _find_plan_files(), _is_governance_surface(), _is_planning_evidence_surface(), _load_json_safe(), main(), _matching_execution_scopes() (+8 more)
...
### Community 50 - "Overlord Validate closeout"
Cohesion: 0.32
...
### Community 57 - "Overlord Check stage6 closeout"
Cohesion: 0.33
...
### Community 59 - "Overlord Check org repo inventory"
Cohesion: 0.51
Nodes (1): TestOrgRepoInventory

### Community 60 - "Overlord Validate session error patterns"
Cohesion: 0.24
...
### Community 62 - "Deploy Inventory direct upload projects"
Cohesion: 0.33
...
### Community 63 - "Overlord Lane bootstrap"
Cohesion: 0.35
...
### Community 65 - "Knowledge base Graph"
Cohesion: 0.38
...
### Community 66 - "Orchestrator Delegation Owned"
Cohesion: 0.45
...
### Community 67 - "Overlord Validate registry surfaces"
Cohesion: 0.49
...
### Community 72 - "Knowledge base Graphify usage logging"
Cohesion: 0.61
...
### Community 82 - "Overlord Sweep artifact pr"
Cohesion: 0.7
Nodes (4): artifact_branch(), artifact_scope(), main(), write_scope()

### Community 83 - "Knowledge base Log graphify usage"
Cohesion: 0.7
Nodes (4): append_event(), build_event(), main(), parse_args()

### Community 84 - "Packet Hitl relay schema"
Cohesion: 0.8
Nodes (4): _load(), test_invalid_hitl_relay_examples_fail(), test_valid_hitl_relay_examples_pass(), _validator()

### Community 85 - "Overlord Validate session surfaces"
Cohesion: 0.83
Nodes (3): _find_hook_command(), main(), validate()

### Community 86 - "Deploy Inventory direct upload projects"
Cohesion: 0.5
Nodes (0): 

### Community 87 - "Knowledge base Graphify governance"
Cohesion: 0.83
Nodes (3): check(), is_ignored(), main()

### Community 88 - "Knowledge base Update knowledge"
Cohesion: 0.83
Nodes (3): main(), replace_section(), summary_line()

### Community 89 - "Packages Hldpro sim Stampede"
Cohesion: 0.67
Nodes (2): MockProvider, test_stampede_e2e()

### Community 90 - "Overlord Render github issue feed"
Cohesion: 1.0
Nodes (2): main(), render_issue()

### Community 91 - "Knowledge base Push graph to neo4j"
Cohesion: 1.0
Nodes (2): build_scoped_graph(), main()

### Community 92 - "Packages Hldpro sim Runner"
Cohesion: 0.67
Nodes (0): 

### Community 93 - "Packages Hldpro sim Engine"
Cohesion: 1.0
Nodes (0): 

### Community 94 - "Packages Hldpro sim Artifacts"
Cohesion: 1.0
Nodes (0): 

### Community 95 - "Windows ollama Submit Temporary"
Cohesion: 1.0
Nodes (1): Temporary audit directory for testing.

### Community 96 - "Som client Som client From"
Cohesion: 1.0
Nodes (1): Build a client from well-known environment variables.

### Community 97 - "Packages Hldpro sim Personas"
Cohesion: 1.0
