...
## Corpus Check
- Large corpus: 1435 files · ~334,882 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 838 nodes · 1531 edges · 44 communities detected
- Extraction: 53% EXTRACTED · 47% INFERRED · 0% AMBIGUOUS · INFERRED: 727 edges (avg confidence: 0.5)
...
- `GateError` --inherits--> `RuntimeError`  [EXTRACTED]
  tools/local-ci-gate/local_ci_gate.py →   _Bridges community 5 → community 18_
- `HelperError` --inherits--> `RuntimeError`  [EXTRACTED]
  scripts/knowledge_base/graphify_hook_helper.py →   _Bridges community 18 → community 8_
...
### Community 15 - "Overlord Workflow local coverage"
Cohesion: 0.21
...
### Community 16 - "Orchestrator Packet queue"
Cohesion: 0.2
...
### Community 17 - "Local ci gate Local ci gate Profile"
Cohesion: 0.1
Nodes (1): TestLocalCiGate

### Community 18 - "Overlord Deploy local ci gate"
Cohesion: 0.25
...
### Community 19 - "Orchestrator Read only observer"
Cohesion: 0.22
...
### Community 20 - "Overlord Deploy local ci gate"
Cohesion: 0.27
...
### Community 22 - "Overlord Check progress github issue staleness"
Cohesion: 0.23
...
### Community 24 - "Lam Runtime inventory"
Cohesion: 0.18
Nodes (2): FakeResponse, TestRuntimeInventory

### Community 25 - "Knowledge base Graph"
Cohesion: 0.38
...
### Community 26 - "Overlord Validate backlog gh sync"
Cohesion: 0.29
...
### Community 31 - "Knowledge base Graphify usage logging"
Cohesion: 0.61
...
### Community 32 - "Overlord Effectiveness metrics"
Cohesion: 0.46
...
### Community 35 - "Overlord Check overlord backlog github alignment"
Cohesion: 0.67
Nodes (5): collect_section_lines(), fail(), has_issue_ref(), main(), parse_markdown_row()

### Community 36 - "Knowledge base Log graphify usage"
Cohesion: 0.7
Nodes (4): append_event(), build_event(), main(), parse_args()

### Community 37 - "Knowledge base Graphify governance"
Cohesion: 0.83
Nodes (3): check(), is_ignored(), main()

### Community 38 - "Knowledge base Update knowledge"
Cohesion: 0.83
Nodes (3): main(), replace_section(), summary_line()

### Community 39 - "Packet Emit Yaml"
Cohesion: 0.67
Nodes (3): emit_packet(), main(), Emit a packet YAML file.     Returns: path to written file

### Community 40 - "Overlord Render github issue feed"
Cohesion: 1.0
Nodes (2): main(), render_issue()

### Community 41 - "Knowledge base Push graph to neo4j"
Cohesion: 1.0
Nodes (2): build_scoped_graph(), main()

### Community 42 - "Windows ollama Init"
Cohesion: 1.0
Nodes (0): 

### Community 43 - "Windows ollama Submit Temporary"
Cohesion: 1.0
...
- **Should `Windows ollama Audit` be split into smaller, more focused modules?**
