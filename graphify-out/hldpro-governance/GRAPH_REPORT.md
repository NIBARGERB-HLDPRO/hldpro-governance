# Graph Report - hldpro-governance  (2026-05-01)

## Corpus Check
- Large corpus: 3561 files · ~775,651 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 2356 nodes · 4824 edges · 115 communities detected
- Extraction: 47% EXTRACTED · 53% INFERRED · 0% AMBIGUOUS · INFERRED: 2556 edges (avg confidence: 0.5)
...
### Community 3 - "Overlord Validate structured agent cycle plan"
Cohesion: 0.08
...
### Community 7 - "Packet Validate hitl relay"
Cohesion: 0.08
...
### Community 8 - "Overlord Validate handoff package Closeout"
Cohesion: 0.09
...
### Community 9 - "Som client Som client Check"
Cohesion: 0.08
...
### Community 10 - "Windows ollama Audit"
Cohesion: 0.06
...
### Community 15 - "Deploy Deploy gate Run"
Cohesion: 0.13
...
### Community 16 - "Packages Hldpro sim"
Cohesion: 0.06
...
### Community 17 - "Local ci gate Local ci gate Report"
Cohesion: 0.12
...
### Community 18 - "Fail closed missing"
Cohesion: 0.07
...
### Community 21 - "Overlord Pentagi sweep"
Cohesion: 0.12
...
### Community 22 - "Overlord Check governance issue branch parity"
Cohesion: 0.09
...
### Community 23 - "Orchestrator Self learning"
Cohesion: 0.14
...
### Community 24 - "Deploy Deploy gate Missing"
Cohesion: 0.17
...
### Community 25 - "Overlord Validate handoff package"
Cohesion: 0.23
...
### Community 26 - "Overlord Report governance consumer status"
Cohesion: 0.12
...
### Community 30 - "Packet Validate Load"
Cohesion: 0.1
...
### Community 41 - "Remote mcp Operator connectivity"
Cohesion: 0.16
...
### Community 42 - "Orchestrator Delegation gate"
Cohesion: 0.15
...
### Community 43 - "Overlord Workflow local coverage"
Cohesion: 0.21
...
### Community 44 - "Overlord Check governance execution scope"
Cohesion: 0.43
Nodes (3): _git(), RepoFixture, TestCheckGovernanceHookExecutionScope

### Community 45 - "Overlord Check plan preflight"
Cohesion: 0.19
Nodes (2): _run(), TestPlanPreflight

### Community 46 - "Orchestrator Read only observer"
Cohesion: 0.22
...
### Community 47 - "Overlord Deploy local ci gate"
Cohesion: 0.27
Nodes (1): TestDeployLocalCIGate

### Community 48 - "Overlord Check worker handoff route"
Cohesion: 0.37
Nodes (4): _git(), RepoFixture, _scope(), TestWorkerHandoffRoute

### Community 49 - "Overlord Deploy local ci gate"
Cohesion: 0.27
...
### Community 55 - "Session bootstrap Extract"
Cohesion: 0.27
...
### Community 61 - "Overlord Validate governed repos"
Cohesion: 0.26
Nodes (1): GovernedReposValidationTests

### Community 62 - "Packet Emit Governance"
Cohesion: 0.19
...
### Community 63 - "Bootstrap repo Exercise"
Cohesion: 0.29
...
### Community 74 - "Codex fire Failure"
Cohesion: 0.36
...
### Community 77 - "Knowledge base Graph"
Cohesion: 0.38
...
### Community 78 - "Check acceptance audit"
Cohesion: 0.36
Nodes (9): Branch like 'feature/closes-issue-42-x' must NOT inherit issue-42's gate., _run_checker(), test_embedded_issue_ref_not_matched(), test_fail_verdict_rejected(), test_no_artifact_present(), test_non_issue_branch_exempt(), test_pass_artifact_matching_issue(), test_pass_artifact_wrong_issue() (+1 more)

### Community 79 - "Overlord Validate cross review evidence"
Cohesion: 0.31
...
### Community 80 - "Overlord Validate registry surfaces"
Cohesion: 0.49
...
### Community 96 - "Overlord Validate session surfaces"
Cohesion: 0.7
Nodes (4): _find_hook_command(), main(), _normalized(), validate()

### Community 97 - "Overlord Sweep artifact pr"
Cohesion: 0.7
Nodes (4): artifact_branch(), artifact_scope(), main(), write_scope()

### Community 98 - "Knowledge base Log graphify usage"
Cohesion: 0.7
Nodes (4): append_event(), build_event(), main(), parse_args()

### Community 99 - "Packet Hitl relay schema"
Cohesion: 0.8
Nodes (4): _load(), test_invalid_hitl_relay_examples_fail(), test_valid_hitl_relay_examples_pass(), _validator()

### Community 100 - "Packet Run specialist packet"
Cohesion: 0.6
Nodes (2): _packet(), RunSpecialistPacketTests

### Community 101 - "Deploy Inventory direct upload projects"
Cohesion: 0.5
Nodes (0): 

### Community 102 - "Knowledge base Graphify governance"
Cohesion: 0.83
Nodes (3): check(), is_ignored(), main()

### Community 103 - "Knowledge base Update knowledge"
Cohesion: 0.83
Nodes (3): main(), replace_section(), summary_line()

### Community 104 - "Packages Hldpro sim Stampede"
Cohesion: 0.67
Nodes (2): MockProvider, test_stampede_e2e()

### Community 105 - "Overlord Render github issue feed"
Cohesion: 1.0
Nodes (2): main(), render_issue()

### Community 106 - "Knowledge base Push graph to neo4j"
Cohesion: 1.0
Nodes (2): build_scoped_graph(), main()

### Community 107 - "Packages Hldpro sim Api"
Cohesion: 0.67
Nodes (0): 

### Community 108 - "Packages Hldpro sim Runner"
Cohesion: 0.67
Nodes (0): 

### Community 109 - "Packages Hldpro sim Engine"
Cohesion: 1.0
Nodes (0): 

### Community 110 - "Packages Hldpro sim Artifacts"
Cohesion: 1.0
Nodes (0): 

### Community 111 - "Fail closed missing Each"
Cohesion: 1.0
Nodes (1): Each workflow must contain a step whose run: block exits 1 on empty BASE_SHA.

### Community 112 - "Windows ollama Submit Temporary"
Cohesion: 1.0
Nodes (1): Temporary audit directory for testing.

### Community 113 - "Som client Som client From"
Cohesion: 1.0
Nodes (1): Build a client from well-known environment variables.

### Community 114 - "Packages Hldpro sim Personas"
Cohesion: 1.0
Nodes (1): Convenience: prefer process-agents/ with bundled personas/ fallback.

## Knowledge Gaps
- **174 isolated node(s):** `Shared pytest fixtures for governance contract tests.  Fixtures -------- tmp_git`, `Yield a temporary directory initialised as a git repo.`, `Write a sample cross-review artifact and return (path, frontmatter_dict).`, `Environment variables simulating a push event with no PR context.`, `Environment variables simulating a valid PR event.` (+169 more)
