...
## Corpus Check
- Large corpus: 1787 files · ~455,092 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1385 nodes · 2598 edges · 75 communities detected
- Extraction: 51% EXTRACTED · 49% INFERRED · 0% AMBIGUOUS · INFERRED: 1262 edges (avg confidence: 0.5)
...
### Community 51 - "Packages Hldpro sim Providers"
Cohesion: 0.2
Nodes (0): 

### Community 52 - "Codex fire Failure"
Cohesion: 0.5
...
### Community 53 - "Overlord Branch switch guard"
Cohesion: 0.39
Nodes (2): run_hook(), TestBranchSwitchGuard

### Community 54 - "Overlord Memory integrity"
Cohesion: 0.42
...
### Community 55 - "Knowledge base Graphify usage logging"
Cohesion: 0.61
...
### Community 69 - "Packages Hldpro sim Runner"
Cohesion: 0.67
Nodes (0): 

### Community 70 - "Packages Hldpro sim Engine"
Cohesion: 1.0
Nodes (0): 

### Community 71 - "Packages Hldpro sim Artifacts"
Cohesion: 1.0
Nodes (0): 
...
### Community 74 - "Packages Hldpro sim Personas"
Cohesion: 1.0
Nodes (1): Convenience: load shared dir from bundled package personas/.

## Knowledge Gaps
- **114 isolated node(s):** `Exercise lam bootstrap with command-like vault values and missing optional keys.`, `Exercise vault discovery from sibling governance worktrees.`, `Submit requests to Windows-Ollama endpoint with PII detection and allowlist enfo`, `Initialize the submitter.          Args:             endpoint: Windows-Ollama en`, `Load PII patterns from pii_patterns.yml.` (+109 more)
...
- **What connects `Exercise lam bootstrap with command-like vault values and missing optional keys.`, `Exercise vault discovery from sibling governance worktrees.`, `Submit requests to Windows-Ollama endpoint with PII detection and allowlist enfo` to the rest of the system?**
