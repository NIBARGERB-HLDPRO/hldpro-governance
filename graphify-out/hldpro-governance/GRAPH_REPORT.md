...
## Corpus Check
- Large corpus: 1378 files · ~300,132 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 680 nodes · 1383 edges · 38 communities detected
- Extraction: 47% EXTRACTED · 53% INFERRED · 0% AMBIGUOUS · INFERRED: 734 edges (avg confidence: 0.5)
...
8. `RepoFixture` - 20 edges
9. `TestGovernanceSurfacePlanGate` - 17 edges
...
### Community 4 - "Orchestrator Self learning"
Cohesion: 0.15
...
### Community 7 - "Knowledge base Measure graphify usage"
Cohesion: 0.16
...
### Community 8 - "Orchestrator Read only observer"
Cohesion: 0.15
...
### Community 10 - "Overlord Org governance compendium"
Cohesion: 0.19
...
### Community 15 - "Overlord Check progress github issue staleness"
Cohesion: 0.23
...
### Community 20 - "Knowledge base Graph"
Cohesion: 0.38
...
### Community 21 - "Overlord Validate backlog gh sync"
Cohesion: 0.29
...
### Community 25 - "Knowledge base Graphify usage logging"
Cohesion: 0.61
...
### Community 30 - "Windows ollama Pii"
Cohesion: 0.4
...
### Community 31 - "Knowledge base Log graphify usage"
Cohesion: 0.7
Nodes (4): append_event(), build_event(), main(), parse_args()

### Community 32 - "Knowledge base Graphify governance"
Cohesion: 0.83
Nodes (3): check(), is_ignored(), main()

### Community 33 - "Knowledge base Update knowledge"
Cohesion: 0.83
Nodes (3): main(), replace_section(), summary_line()

### Community 34 - "Packet Emit Yaml"
Cohesion: 0.67
Nodes (3): emit_packet(), main(), Emit a packet YAML file.     Returns: path to written file

### Community 35 - "Overlord Render github issue feed"
Cohesion: 1.0
Nodes (2): main(), render_issue()

### Community 36 - "Knowledge base Push graph to neo4j"
Cohesion: 1.0
Nodes (2): build_scoped_graph(), main()

### Community 37 - "Windows ollama Init"
Cohesion: 1.0
Nodes (0): 
