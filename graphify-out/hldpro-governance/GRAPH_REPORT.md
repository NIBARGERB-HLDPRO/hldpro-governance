...
## Corpus Check
- Large corpus: 1835 files · ~473,078 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1448 nodes · 2734 edges · 78 communities detected
- Extraction: 51% EXTRACTED · 49% INFERRED · 0% AMBIGUOUS · INFERRED: 1337 edges (avg confidence: 0.5)
...
### Community 32 - "Orchestrator Packet queue"
Cohesion: 0.29
Nodes (2): _packet(), TestPacketQueue

### Community 33 - "Orchestrator Read only observer"
Cohesion: 0.22
...
### Community 37 - "Overlord Check progress github issue staleness"
Cohesion: 0.23
...
### Community 47 - "Overlord Pentagi sweep"
Cohesion: 0.42
...
### Community 49 - "Overlord Validate handoff package"
Cohesion: 0.49
