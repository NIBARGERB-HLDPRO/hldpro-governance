...
- `GateError` --inherits--> `RuntimeError`  [EXTRACTED]
  tools/local-ci-gate/local_ci_gate.py →   _Bridges community 4 → community 23_
- `GovernanceDeployError` --inherits--> `RuntimeError`  [EXTRACTED]
  scripts/overlord/deploy_governance_tooling.py →   _Bridges community 23 → community 11_
- `HelperError` --inherits--> `RuntimeError`  [EXTRACTED]
  scripts/knowledge_base/graphify_hook_helper.py →   _Bridges community 23 → community 8_
...
### Community 18 - "Overlord Workflow local coverage"
Cohesion: 0.21
...
### Community 20 - "Local ci gate Local ci gate Profile"
Cohesion: 0.1
Nodes (1): TestLocalCiGate

### Community 21 - "Overlord Deploy governance tooling"
Cohesion: 0.32
Nodes (1): TestDeployGovernanceTooling

### Community 22 - "Orchestrator Hitl relay queue"
Cohesion: 0.3
...
### Community 24 - "Orchestrator Read only observer"
Cohesion: 0.22
...
### Community 29 - "Overlord Validate governed repos"
Cohesion: 0.26
Nodes (1): GovernedReposValidationTests

### Community 30 - "Overlord Validate structured agent cycle plan"
Cohesion: 0.35
...
### Community 32 - "Lam Runtime inventory"
Cohesion: 0.18
Nodes (2): FakeResponse, TestRuntimeInventory

### Community 33 - "Knowledge base Graph"
Cohesion: 0.38
...
### Community 34 - "Orchestrator Hitl relay queue"
Cohesion: 0.45
...
### Community 35 - "Overlord Validate backlog gh sync"
Cohesion: 0.29
...
### Community 36 - "Overlord Validate registry surfaces"
Cohesion: 0.49
...
### Community 38 - "Knowledge base Graphify targets"
Cohesion: 0.38
