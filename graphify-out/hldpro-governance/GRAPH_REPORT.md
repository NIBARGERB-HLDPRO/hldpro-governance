...
## Corpus Check
- Large corpus: 1560 files · ~373,935 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1051 nodes · 2023 edges · 58 communities detected
- Extraction: 50% EXTRACTED · 50% INFERRED · 0% AMBIGUOUS · INFERRED: 1014 edges (avg confidence: 0.5)
...
- `GateError` --inherits--> `RuntimeError`  [EXTRACTED]
  tools/local-ci-gate/local_ci_gate.py →   _Bridges community 4 → community 24_
...
### Community 15 - "Windows ollama Audit"
Cohesion: 0.14
...
### Community 33 - "Lam Runtime inventory"
Cohesion: 0.18
Nodes (2): FakeResponse, TestRuntimeInventory

### Community 34 - "Knowledge base Graph"
Cohesion: 0.38
...
### Community 35 - "Orchestrator Delegation Owned"
Cohesion: 0.45
...
### Community 36 - "Orchestrator Hitl relay queue"
Cohesion: 0.45
...
### Community 37 - "Overlord Validate backlog gh sync"
Cohesion: 0.29
...
### Community 38 - "Overlord Validate registry surfaces"
Cohesion: 0.49
...
### Community 42 - "Overlord Governed repos"
Cohesion: 0.42
