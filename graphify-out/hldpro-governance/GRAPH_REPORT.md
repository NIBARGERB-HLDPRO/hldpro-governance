...
## Corpus Check
- Large corpus: 1634 files · ~402,562 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1105 nodes · 2299 edges · 58 communities detected
...
### Community 8 - "Packet Validate hitl relay"
Cohesion: 0.12
...
### Community 17 - "Orchestrator Delegation gate"
Cohesion: 0.15
...
### Community 49 - "Windows ollama Pii"
Cohesion: 0.4
