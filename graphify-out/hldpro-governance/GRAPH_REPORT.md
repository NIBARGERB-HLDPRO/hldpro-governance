...
## Corpus Check
- Large corpus: 1372 files · ~296,881 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 647 nodes · 1318 edges · 37 communities detected
- Extraction: 47% EXTRACTED · 53% INFERRED · 0% AMBIGUOUS · INFERRED: 701 edges (avg confidence: 0.5)
...
### Community 11 - "Windows ollama Audit"
Cohesion: 0.13
...
### Community 12 - "Orchestrator Packet queue"
Cohesion: 0.21
...
### Community 14 - "Overlord Check progress github issue staleness"
Cohesion: 0.23
...
### Community 16 - "Lam Runtime inventory"
Cohesion: 0.18
...
### Community 18 - "Knowledge base Graph"
Cohesion: 0.38
...
### Community 19 - "Overlord Validate backlog gh sync"
Cohesion: 0.29
...
### Community 23 - "Knowledge base Graphify usage logging"
Cohesion: 0.61
...
### Community 24 - "Overlord Effectiveness metrics"
Cohesion: 0.46
Nodes (7): collect_repo_metrics(), main(), parse_iso(), pct(), render_markdown(), RepoMetrics, run()

### Community 25 - "Orchestrator Self learning"
Cohesion: 0.36
Nodes (2): TestSelfLearning, _write_fixture()

### Community 26 - "Overlord Validate governed repos"
Cohesion: 0.67
...
### Community 29 - "Windows ollama Pii"
Cohesion: 0.4
...
### Community 30 - "Knowledge base Log graphify usage"
Cohesion: 0.7
Nodes (4): append_event(), build_event(), main(), parse_args()

### Community 31 - "Knowledge base Graphify governance"
Cohesion: 0.83
Nodes (3): check(), is_ignored(), main()

### Community 32 - "Knowledge base Update knowledge"
Cohesion: 0.83
Nodes (3): main(), replace_section(), summary_line()

### Community 33 - "Packet Emit Yaml"
Cohesion: 0.67
Nodes (3): emit_packet(), main(), Emit a packet YAML file.     Returns: path to written file

### Community 34 - "Overlord Render github issue feed"
Cohesion: 1.0
Nodes (2): main(), render_issue()

### Community 35 - "Knowledge base Push graph to neo4j"
Cohesion: 1.0
Nodes (2): build_scoped_graph(), main()

### Community 36 - "Windows ollama Init"
Cohesion: 1.0
Nodes (0): 
