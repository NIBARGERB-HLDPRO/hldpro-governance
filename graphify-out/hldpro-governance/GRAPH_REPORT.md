...
## Corpus Check
- Large corpus: 3569 files · ~778,745 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 2346 nodes · 4808 edges · 114 communities detected
- Extraction: 47% EXTRACTED · 53% INFERRED · 0% AMBIGUOUS · INFERRED: 2549 edges (avg confidence: 0.5)
...
### Community 17 - "Fail closed missing"
Cohesion: 0.07
...
### Community 20 - "Local ci gate Local ci gate Report"
Cohesion: 0.12
...
### Community 78 - "Overlord Validate cross review evidence"
Cohesion: 0.31
...
### Community 79 - "Overlord Validate registry surfaces"
Cohesion: 0.49
...
### Community 89 - "Overlord Validate governed repos"
Cohesion: 0.67
Nodes (6): check(), fail(), load_json(), main(), validate_graphify_reconciliation(), validate_registry_shape()

### Community 90 - "Orchestrator Read only observer"
Cohesion: 0.48
Nodes (2): _copy_fixture(), TestReadOnlyObserver

### Community 91 - "Functional acceptance auditor"
Cohesion: 0.6
Nodes (4): _load_json(), _sample_pass_audit(), test_schema_accepts_sample_pass_audit(), test_schema_rejects_missing_overall_verdict()

### Community 92 - "Packages Hldpro sim Process"
Cohesion: 0.33
Nodes (0): 

### Community 93 - "Packages Hldpro sim Stampede"
Cohesion: 0.4
Nodes (4): BaseAggregator, BaseModel, NarrativeAggregator, NarrativeOutcome

### Community 94 - "Overlord Sweep artifact pr"
Cohesion: 0.4
Nodes (1): SweepArtifactPrTest

### Community 95 - "Overlord Validate session surfaces"
Cohesion: 0.7
Nodes (4): _find_hook_command(), main(), _normalized(), validate()

### Community 96 - "Overlord Sweep artifact pr"
Cohesion: 0.7
Nodes (4): artifact_branch(), artifact_scope(), main(), write_scope()

### Community 97 - "Knowledge base Log graphify usage"
Cohesion: 0.7
Nodes (4): append_event(), build_event(), main(), parse_args()

### Community 98 - "Packet Hitl relay schema"
Cohesion: 0.8
Nodes (4): _load(), test_invalid_hitl_relay_examples_fail(), test_valid_hitl_relay_examples_pass(), _validator()

### Community 99 - "Packet Run specialist packet"
Cohesion: 0.6
Nodes (2): _packet(), RunSpecialistPacketTests

### Community 100 - "Deploy Inventory direct upload projects"
Cohesion: 0.5
Nodes (0): 

### Community 101 - "Knowledge base Graphify governance"
Cohesion: 0.83
Nodes (3): check(), is_ignored(), main()

### Community 102 - "Knowledge base Update knowledge"
Cohesion: 0.83
Nodes (3): main(), replace_section(), summary_line()

### Community 103 - "Packages Hldpro sim Stampede"
Cohesion: 0.67
Nodes (2): MockProvider, test_stampede_e2e()

### Community 104 - "Overlord Render github issue feed"
Cohesion: 1.0
Nodes (2): main(), render_issue()

### Community 105 - "Knowledge base Push graph to neo4j"
Cohesion: 1.0
Nodes (2): build_scoped_graph(), main()

### Community 106 - "Packages Hldpro sim Api"
Cohesion: 0.67
Nodes (0): 

### Community 107 - "Packages Hldpro sim Runner"
Cohesion: 0.67
Nodes (0): 

### Community 108 - "Packages Hldpro sim Engine"
Cohesion: 1.0
Nodes (0): 

### Community 109 - "Packages Hldpro sim Artifacts"
Cohesion: 1.0
Nodes (0): 

### Community 110 - "Fail closed missing Each"
Cohesion: 1.0
Nodes (1): Each workflow must contain a step whose run: block exits 1 on empty BASE_SHA.

### Community 111 - "Windows ollama Submit Temporary"
Cohesion: 1.0
Nodes (1): Temporary audit directory for testing.

### Community 112 - "Som client Som client From"
Cohesion: 1.0
Nodes (1): Build a client from well-known environment variables.

### Community 113 - "Packages Hldpro sim Personas"
Cohesion: 1.0
Nodes (1): Convenience: prefer process-agents/ with bundled personas/ fallback.

## Knowledge Gaps
- **173 isolated node(s):** `Shared pytest fixtures for governance contract tests.  Fixtures -------- tmp_git`, `Yield a temporary directory initialised as a git repo.`, `Write a sample cross-review artifact and return (path, frontmatter_dict).`, `Environment variables simulating a push event with no PR context.`, `Environment variables simulating a valid PR event.` (+168 more)
