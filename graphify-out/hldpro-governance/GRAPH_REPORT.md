...
## Corpus Check
- Large corpus: 1421 files · ~331,654 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 831 nodes · 1507 edges · 45 communities detected
- Extraction: 53% EXTRACTED · 47% INFERRED · 0% AMBIGUOUS · INFERRED: 710 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## God Nodes (most connected - your core abstractions)
1. `_tier1_packet()` - 29 edges
2. `TestAssertExecutionScope` - 23 edges
3. `TestGovernanceSurfacePlanGate` - 21 edges
4. `RepoFixture` - 20 edges
5. `TestLocalCiGate` - 19 edges
6. `TestDeployLocalCIGate` - 16 edges
7. `TestPacketQueue` - 15 edges
8. `describe_file()` - 14 edges
9. `TestLocalCiGateWorkflowContract` - 13 edges
10. `graphify_results()` - 13 edges

## Surprising Connections (you probably didn't know these)
- `GateError` --inherits--> `RuntimeError`  [EXTRACTED]
  tools/local-ci-gate/local_ci_gate.py →   _Bridges community 4 → community 19_
- `HelperError` --inherits--> `RuntimeError`  [EXTRACTED]
  scripts/knowledge_base/graphify_hook_helper.py →   _Bridges community 19 → community 7_
...
### Community 11 - "Overlord Check local ci gate workflow"
Cohesion: 0.11
...
### Community 12 - "Windows ollama Audit"
Cohesion: 0.14
...
### Community 18 - "Local ci gate Local ci gate Profile"
Cohesion: 0.1
Nodes (1): TestLocalCiGate

### Community 19 - "Overlord Deploy local ci gate"
Cohesion: 0.25
...
### Community 20 - "Orchestrator Read only observer"
Cohesion: 0.22
...
### Community 23 - "Overlord Check progress github issue staleness"
Cohesion: 0.23
...
### Community 26 - "Knowledge base Graph"
Cohesion: 0.38
...
### Community 27 - "Overlord Validate backlog gh sync"
Cohesion: 0.29
...
### Community 32 - "Knowledge base Graphify usage logging"
Cohesion: 0.61
...
### Community 33 - "Overlord Effectiveness metrics"
Cohesion: 0.46
Nodes (7): collect_repo_metrics(), main(), parse_iso(), pct(), render_markdown(), RepoMetrics, run()

### Community 34 - "Overlord Validate governed repos"
Cohesion: 0.67
...
### Community 37 - "Knowledge base Log graphify usage"
Cohesion: 0.7
Nodes (4): append_event(), build_event(), main(), parse_args()

### Community 38 - "Knowledge base Graphify governance"
Cohesion: 0.83
Nodes (3): check(), is_ignored(), main()

### Community 39 - "Knowledge base Update knowledge"
Cohesion: 0.83
Nodes (3): main(), replace_section(), summary_line()

### Community 40 - "Packet Emit Yaml"
Cohesion: 0.67
Nodes (3): emit_packet(), main(), Emit a packet YAML file.     Returns: path to written file

### Community 41 - "Overlord Render github issue feed"
Cohesion: 1.0
Nodes (2): main(), render_issue()

### Community 42 - "Knowledge base Push graph to neo4j"
Cohesion: 1.0
Nodes (2): build_scoped_graph(), main()

### Community 43 - "Windows ollama Init"
Cohesion: 1.0
Nodes (0): 

### Community 44 - "Windows ollama Submit Temporary"
Cohesion: 1.0
...
- **Are the 17 inferred relationships involving `RepoFixture` (e.g. with `.test_allows_changes_in_allowed_paths_dirty_tree_mode()` and `.test_planning_only_diff_inside_allowed_paths_passes()`) actually correct?**
  _`RepoFixture` has 17 INFERRED edges - model-reasoned connections that need verification._
