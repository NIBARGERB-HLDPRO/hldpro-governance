...
## Corpus Check
- Large corpus: 1348 files · ~285,282 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 582 nodes · 1124 edges · 35 communities detected
- Extraction: 49% EXTRACTED · 51% INFERRED · 0% AMBIGUOUS · INFERRED: 571 edges (avg confidence: 0.5)
...
7. `TestGovernanceSurfacePlanGate` - 15 edges
...
### Community 8 - "Windows ollama Audit"
Cohesion: 0.13
...
### Community 11 - "Overlord Check progress github issue staleness"
Cohesion: 0.23
...
### Community 14 - "Lam Runtime inventory"
Cohesion: 0.18
...
### Community 16 - "Knowledge base Graph"
Cohesion: 0.38
...
### Community 18 - "Overlord Validate backlog gh sync"
Cohesion: 0.29
...
### Community 22 - "Knowledge base Graphify usage logging"
Cohesion: 0.61
...
### Community 23 - "Overlord Effectiveness metrics"
Cohesion: 0.46
Nodes (7): collect_repo_metrics(), main(), parse_iso(), pct(), render_markdown(), RepoMetrics, run()

### Community 24 - "Overlord Validate governed repos"
Cohesion: 0.67
...
### Community 27 - "Windows ollama Pii"
Cohesion: 0.4
...
### Community 33 - "Knowledge base Push graph to neo4j"
Cohesion: 1.0
Nodes (2): build_scoped_graph(), main()

### Community 34 - "Windows ollama Init"
Cohesion: 1.0
Nodes (0): 
