...
## Corpus Check
- Large corpus: 3243 files · ~676,858 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1720 nodes · 3402 edges · 85 communities detected
- Extraction: 49% EXTRACTED · 51% INFERRED · 0% AMBIGUOUS · INFERRED: 1742 edges (avg confidence: 0.5)
...
5. `TestGovernanceSurfacePlanGate` - 24 edges
6. `TestLocalCiGate` - 22 edges
7. `_validate_record()` - 19 edges
8. `TestDeployGovernanceTooling` - 19 edges
9. `TestDeployLocalCIGate` - 16 edges
10. `write_config()` - 16 edges
...
Cohesion: 0.03
Nodes (52): AuditWriter, canonical_json(), compute_entry_hmac(), compute_sha256(), Write an audit entry. Returns True if successful, False otherwise.          Args, Return canonical JSON for HMAC computation., Write or update today's manifest., Compute SHA256 hash of bytes. (+44 more)

### Community 1 - "Deploy Deploy gate Windows"
Cohesion: 0.05
Nodes (59): Exception, ArtifactStats, _check_pages_limits(), count_files(), deploy(), emit_evidence(), enforce_pages_limits(), extract_deployment_url() (+51 more)
...
### Community 6 - "Overlord Verify governance consumer"
Cohesion: 0.2
...
### Community 8 - "Local ci gate Local ci gate Report"
Cohesion: 0.12
...
### Community 9 - "Orchestrator Packet queue"
Cohesion: 0.12
...
### Community 10 - "Overlord Pentagi sweep"
Cohesion: 0.12
...
### Community 13 - "Packages Hldpro sim"
Cohesion: 0.06
...
### Community 18 - "Knowledge base Graphify"
Cohesion: 0.13
...
### Community 19 - "Packet Validate hitl relay"
Cohesion: 0.12
...
### Community 20 - "Packet Validate Load"
Cohesion: 0.1
...
### Community 21 - "Orchestrator Hitl relay queue"
Cohesion: 0.19
...
### Community 23 - "Knowledge base Measure graphify usage"
Cohesion: 0.16
...
### Community 24 - "Overlord Check local ci gate workflow"
Cohesion: 0.11
...
### Community 26 - "Deploy Deploy gate Missing"
Cohesion: 0.28
...
### Community 27 - "Local ci gate Local ci gate Profile"
Cohesion: 0.09
Nodes (1): TestLocalCiGate

### Community 28 - "Overlord Org governance compendium"
Cohesion: 0.19
Nodes (21): build(), category_for(), describe_file(), esc(), FileInfo, first_comment(), first_heading(), frontmatter_field() (+13 more)

### Community 29 - "Remote mcp Operator connectivity"
Cohesion: 0.16
...
### Community 30 - "Orchestrator Delegation gate"
Cohesion: 0.15
...
### Community 31 - "Overlord Workflow local coverage"
Cohesion: 0.21
...
### Community 35 - "Orchestrator Read only observer"
Cohesion: 0.22
...
### Community 41 - "Remote mcp Monitor alert"
Cohesion: 0.23
...
### Community 50 - "Overlord Lane bootstrap"
Cohesion: 0.3
...
### Community 54 - "Overlord Branch switch guard"
Cohesion: 0.33
Nodes (2): run_hook(), TestBranchSwitchGuard

### Community 55 - "Overlord Check plan preflight"
Cohesion: 0.33
Nodes (2): _run(), TestPlanPreflight

### Community 56 - "Overlord Memory integrity"
Cohesion: 0.35
...
### Community 57 - "Knowledge base Graph"
Cohesion: 0.38
...
### Community 58 - "Orchestrator Delegation Owned"
Cohesion: 0.45
...
### Community 59 - "Orchestrator Hitl relay queue"
Cohesion: 0.45
...
### Community 60 - "Overlord Validate registry surfaces"
Cohesion: 0.49
...
### Community 65 - "Knowledge base Graphify usage logging"
Cohesion: 0.61
...
### Community 77 - "Overlord Render github issue feed"
Cohesion: 1.0
Nodes (2): main(), render_issue()

### Community 78 - "Knowledge base Push graph to neo4j"
Cohesion: 1.0
Nodes (2): build_scoped_graph(), main()

### Community 79 - "Packages Hldpro sim Runner"
Cohesion: 0.67
Nodes (0): 

### Community 80 - "Packages Hldpro sim Engine"
Cohesion: 1.0
Nodes (0): 

### Community 81 - "Packages Hldpro sim Artifacts"
Cohesion: 1.0
Nodes (0): 

### Community 82 - "Windows ollama Submit Temporary"
Cohesion: 1.0
Nodes (1): Temporary audit directory for testing.

### Community 83 - "Som client Som client From"
Cohesion: 1.0
Nodes (1): Build a client from well-known environment variables.

### Community 84 - "Packages Hldpro sim Personas"
Cohesion: 1.0
Nodes (1): Convenience: load shared dir from bundled package personas/.

## Knowledge Gaps
- **126 isolated node(s):** `Exercise lam bootstrap with command-like vault values and missing optional keys.`, `Exercise vault discovery from sibling governance worktrees.`, `Exercise vault discovery from HLDPRO/var/worktrees/* governance worktrees.`, `Exercise Seek/Ponder bootstrap aliases without leaking synthetic values.`, `Exercise Stampede bootstrap with production Tradier mapping and redaction.` (+121 more)
