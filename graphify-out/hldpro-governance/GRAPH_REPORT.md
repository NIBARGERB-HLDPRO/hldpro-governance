...
## Corpus Check
- Large corpus: 1887 files · ~492,301 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1599 nodes · 3072 edges · 84 communities detected
- Extraction: 50% EXTRACTED · 50% INFERRED · 0% AMBIGUOUS · INFERRED: 1532 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## God Nodes (most connected - your core abstractions)
1. `TestAssertExecutionScope` - 34 edges
2. `_tier1_packet()` - 31 edges
3. `RepoFixture` - 30 edges
4. `TestVerifyGovernanceConsumer` - 27 edges
5. `TestGovernanceSurfacePlanGate` - 24 edges
6. `TestLocalCiGate` - 22 edges
7. `TestDeployGovernanceTooling` - 19 edges
8. `_validate_record()` - 18 edges
9. `TestDeployLocalCIGate` - 16 edges
10. `TestPacketQueue` - 16 edges
...
### Community 7 - "Overlord Pentagi sweep"
Cohesion: 0.12
...
Cohesion: 0.13
Nodes (32): build_parser(), _consumer_record_relpath(), ConsumerRecord, ConsumerVerifyError, _expected_checksum(), _expected_managed_paths(), _fail(), _git_root() (+24 more)

### Community 14 - "Orchestrator Self learning"
Cohesion: 0.15
...
### Community 15 - "Knowledge base Graphify"
Cohesion: 0.13
...
### Community 16 - "Packet Validate hitl relay"
Cohesion: 0.12
...
### Community 17 - "Packet Validate Load"
Cohesion: 0.1
...
### Community 18 - "Orchestrator Hitl relay queue"
Cohesion: 0.19
...
### Community 19 - "Overlord Deploy governance tooling"
Cohesion: 0.18
...
### Community 20 - "Knowledge base Measure graphify usage"
Cohesion: 0.16
...
### Community 21 - "Overlord Check local ci gate workflow"
Cohesion: 0.11
...
### Community 23 - "Overlord Validate structured agent cycle plan"
Cohesion: 0.15
...
### Community 27 - "Orchestrator Delegation gate"
Cohesion: 0.15
...
### Community 28 - "Overlord Workflow local coverage"
Cohesion: 0.21
...
### Community 29 - "Orchestrator Packet queue"
Cohesion: 0.2
...
### Community 31 - "Overlord Deploy governance tooling"
Cohesion: 0.32
Nodes (1): TestDeployGovernanceTooling

### Community 32 - "Overlord Validate handoff package"
Cohesion: 0.36
Nodes (6): _handoff(), _plan(), _scope(), TestValidateHandoffPackage, _write_json(), _write_supporting_files()

### Community 33 - "Orchestrator Packet queue"
Cohesion: 0.29
Nodes (2): _packet(), TestPacketQueue

### Community 34 - "Orchestrator Read only observer"
Cohesion: 0.22
...
### Community 35 - "Overlord Deploy local ci gate"
Cohesion: 0.27
...
### Community 56 - "Knowledge base Graph"
Cohesion: 0.38
...
### Community 57 - "Orchestrator Delegation Owned"
Cohesion: 0.45
...
### Community 58 - "Orchestrator Hitl relay queue"
Cohesion: 0.45
...
### Community 59 - "Overlord Validate registry surfaces"
Cohesion: 0.49
...
### Community 64 - "Overlord Memory integrity"
Cohesion: 0.42
...
### Community 71 - "Knowledge base Log graphify usage"
Cohesion: 0.7
Nodes (4): append_event(), build_event(), main(), parse_args()

### Community 72 - "Packet Hitl relay schema"
Cohesion: 0.8
Nodes (4): _load(), test_invalid_hitl_relay_examples_fail(), test_valid_hitl_relay_examples_pass(), _validator()

### Community 73 - "Knowledge base Graphify governance"
Cohesion: 0.83
Nodes (3): check(), is_ignored(), main()

### Community 74 - "Knowledge base Update knowledge"
Cohesion: 0.83
Nodes (3): main(), replace_section(), summary_line()

### Community 75 - "Packages Hldpro sim Stampede"
Cohesion: 0.67
Nodes (2): MockProvider, test_stampede_e2e()

### Community 76 - "Overlord Render github issue feed"
Cohesion: 1.0
Nodes (2): main(), render_issue()

### Community 77 - "Knowledge base Push graph to neo4j"
Cohesion: 1.0
Nodes (2): build_scoped_graph(), main()

### Community 78 - "Packages Hldpro sim Runner"
Cohesion: 0.67
Nodes (0): 

### Community 79 - "Packages Hldpro sim Engine"
Cohesion: 1.0
Nodes (0): 

### Community 80 - "Packages Hldpro sim Artifacts"
Cohesion: 1.0
Nodes (0): 

### Community 81 - "Windows ollama Submit Temporary"
Cohesion: 1.0
Nodes (1): Temporary audit directory for testing.

### Community 82 - "Som client Som client From"
Cohesion: 1.0
Nodes (1): Build a client from well-known environment variables.

### Community 83 - "Packages Hldpro sim Personas"
Cohesion: 1.0
Nodes (1): Convenience: load shared dir from bundled package personas/.

## Knowledge Gaps
- **123 isolated node(s):** `Exercise lam bootstrap with command-like vault values and missing optional keys.`, `Exercise vault discovery from sibling governance worktrees.`, `Exercise vault discovery from HLDPRO/var/worktrees/* governance worktrees.`, `Exercise Seek/Ponder bootstrap aliases without leaking synthetic values.`, `Exercise Stampede bootstrap with production Tradier mapping and redaction.` (+118 more)
...
- **Why does `ConsumerVerifyError` connect `Overlord Verify governance consumer` to `Som client Som client Error`?**
