...
## Corpus Check
- Large corpus: 3287 files · ~690,405 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1810 nodes · 3600 edges · 89 communities detected
- Extraction: 48% EXTRACTED · 52% INFERRED · 0% AMBIGUOUS · INFERRED: 1854 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## God Nodes (most connected - your core abstractions)
1. `TestVerifyGovernanceConsumer` - 40 edges
2. `TestAssertExecutionScope` - 34 edges
3. `_tier1_packet()` - 31 edges
4. `RepoFixture` - 30 edges
5. `TestLocalCiGate` - 24 edges
6. `TestGovernanceSurfacePlanGate` - 24 edges
7. `_validate_record()` - 19 edges
8. `TestDeployGovernanceTooling` - 19 edges
9. `write_config()` - 17 edges
10. `TestDeployLocalCIGate` - 16 edges
...
### Community 0 - "Packet Validate Passes"
Cohesion: 0.05
...
### Community 4 - "Som client Som client Deploy"
Cohesion: 0.07
Nodes (26): add_common_args(), build_plan(), _common_preview_payload(), DeployError, DeployPlan, _existing_shim_state(), _fail(), _is_relative_to() (+18 more)
...
### Community 6 - "Overlord Codex ingestion"
Cohesion: 0.1
...
### Community 8 - "Orchestrator Hitl relay queue"
Cohesion: 0.13
...
### Community 10 - "Local ci gate Local ci gate Report"
Cohesion: 0.12
...
### Community 11 - "Orchestrator Packet queue"
Cohesion: 0.12
...
### Community 12 - "Overlord Pentagi sweep"
Cohesion: 0.12
...
Cohesion: 0.13
Nodes (34): ArtifactStats, _check_pages_limits(), count_files(), deploy(), emit_evidence(), enforce_pages_limits(), extract_deployment_url(), fail() (+26 more)
...
### Community 20 - "Knowledge base Graphify"
Cohesion: 0.13
...
### Community 21 - "Remote mcp Stage d"
Cohesion: 0.13
...
### Community 22 - "Packet Validate Load"
Cohesion: 0.1
...
Cohesion: 0.16
Nodes (28): _branch(), build_report(), _cname_note(), _deployment_url(), _domain_label(), _domain_result(), _domains(), emit_summary() (+20 more)
...
### Community 27 - "Deploy Deploy gate Missing"
Cohesion: 0.25
Nodes (25): default_env(), deploy_calls(), FakeCompleted, make_runner(), run_gate(), run_gate_expect_error(), test_build_failure(), test_deploy_requires_approved_flag() (+17 more)

### Community 28 - "Overlord Validate provisioning evidence"
Cohesion: 0.17
...
### Community 29 - "Overlord Validate structured agent cycle plan"
Cohesion: 0.15
Nodes (2): _plan(), TestGovernanceSurfacePlanGate

### Community 30 - "Local ci gate Local ci gate Profile"
Cohesion: 0.08
Nodes (1): TestLocalCiGate

### Community 31 - "Overlord Org governance compendium"
Cohesion: 0.19
Nodes (21): build(), category_for(), describe_file(), esc(), FileInfo, first_comment(), first_heading(), frontmatter_field() (+13 more)

### Community 32 - "Remote mcp Operator connectivity"
Cohesion: 0.16
...
### Community 33 - "Orchestrator Delegation gate"
Cohesion: 0.15
...
### Community 34 - "Overlord Workflow local coverage"
Cohesion: 0.21
...
### Community 35 - "Overlord Deploy governance tooling"
Cohesion: 0.32
Nodes (1): TestDeployGovernanceTooling

### Community 36 - "Overlord Check overlord backlog github alignment"
Cohesion: 0.14
...
### Community 37 - "Deploy Deploy verifier Not"
Cohesion: 0.31
Nodes (16): FakeTransport, response(), run_report(), test_cache_busting_headers(), test_cname_mismatch_not_blocking(), test_different_deployment_ids(), test_domain_not_200(), test_matching_deployment_id() (+8 more)

### Community 38 - "Overlord Validate handoff package"
Cohesion: 0.36
Nodes (6): _handoff(), _plan(), _scope(), TestValidateHandoffPackage, _write_json(), _write_supporting_files()

### Community 39 - "Orchestrator Read only observer"
Cohesion: 0.22
...
### Community 40 - "Overlord Deploy local ci gate"
Cohesion: 0.27
Nodes (1): TestDeployLocalCIGate

### Community 41 - "Overlord Check progress github issue staleness"
Cohesion: 0.23
...
### Community 43 - "Overlord Check org repo inventory"
Cohesion: 0.28
...
### Community 48 - "Packet Emit Governance"
Cohesion: 0.19
...
### Community 49 - "Bootstrap repo Exercise"
Cohesion: 0.29
...
### Community 55 - "Overlord Schema guard"
Cohesion: 0.42
Nodes (3): _payload(), _run_hook(), TestSchemaGuardHook

### Community 56 - "Overlord Lane bootstrap"
Cohesion: 0.35
...
### Community 58 - "Overlord Check plan preflight"
Cohesion: 0.33
...
### Community 60 - "Knowledge base Graph"
Cohesion: 0.38
...
### Community 61 - "Orchestrator Delegation Owned"
Cohesion: 0.45
...
### Community 62 - "Overlord Validate registry surfaces"
Cohesion: 0.49
...
### Community 67 - "Knowledge base Graphify usage logging"
Cohesion: 0.61
...
- **Why does `ConsumerVerifyError` connect `Overlord Verify governance consumer` to `Som client Som client Deploy`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `GateError` connect `Local ci gate Local ci gate Report` to `Som client Som client Deploy`?**
