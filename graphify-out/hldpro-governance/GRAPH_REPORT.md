...
## Corpus Check
- Large corpus: 1887 files · ~490,363 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1574 nodes · 2991 edges · 85 communities detected
- Extraction: 51% EXTRACTED · 49% INFERRED · 0% AMBIGUOUS · INFERRED: 1476 edges (avg confidence: 0.5)
...
5. `TestLocalCiGate` - 22 edges
6. `TestDeployGovernanceTooling` - 19 edges
7. `TestDeployLocalCIGate` - 16 edges
8. `TestPacketQueue` - 16 edges
9. `_write_supporting_files()` - 15 edges
...
### Community 20 - "Overlord Check local ci gate workflow"
Cohesion: 0.11
...
### Community 21 - "Overlord Validate structured agent cycle plan"
Cohesion: 0.15
Nodes (2): _plan(), TestGovernanceSurfacePlanGate

### Community 22 - "Windows ollama Audit"
Cohesion: 0.14
...
### Community 26 - "Orchestrator Delegation gate"
Cohesion: 0.15
...
### Community 27 - "Overlord Workflow local coverage"
Cohesion: 0.21
...
### Community 28 - "Orchestrator Packet queue"
Cohesion: 0.2
...
### Community 29 - "Overlord Verify governance consumer"
Cohesion: 0.2
...
### Community 42 - "Overlord Verify governance consumer"
Cohesion: 0.3
...
### Community 44 - "Overlord Validate structured agent cycle plan"
Cohesion: 0.31
...
### Community 45 - "Overlord Validate governed repos"
Cohesion: 0.26
Nodes (1): GovernedReposValidationTests

### Community 46 - "Packet Emit Governance"
Cohesion: 0.19
...
### Community 47 - "Bootstrap repo Exercise"
Cohesion: 0.29
...
### Community 48 - "Overlord Check org repo inventory"
Cohesion: 0.51
...
### Community 51 - "Overlord Lane bootstrap"
Cohesion: 0.3
Nodes (2): run_helper(), TestLaneBootstrap

### Community 52 - "Cli session supervisor"
Cohesion: 0.56
...
### Community 54 - "Overlord Lane bootstrap"
Cohesion: 0.35
...
### Community 56 - "Overlord Check plan preflight"
Cohesion: 0.33
...
### Community 65 - "Overlord Memory integrity"
Cohesion: 0.42
...
### Community 66 - "Knowledge base Graphify usage logging"
Cohesion: 0.61
