...
## Summary
- 887 nodes · 1837 edges · 44 communities detected
- Extraction: 46% EXTRACTED · 54% INFERRED · 0% AMBIGUOUS · INFERRED: 984 edges (avg confidence: 0.5)
...
6. `TestAssertExecutionScope` - 28 edges
7. `AuditWriter` - 28 edges
8. `RepoFixture` - 25 edges
...
- **Why does `GateError` connect `Community 3` to `Community 20`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `HelperError` connect `Community 7` to `Community 20`?**
