...
## Summary
- 1234 nodes · 2528 edges · 61 communities detected
- Extraction: 47% EXTRACTED · 53% INFERRED · 0% AMBIGUOUS · INFERRED: 1338 edges (avg confidence: 0.5)
...
- **Thin community `Community 59`** (1 nodes): `Build a client from well-known environment variables.`
...
- **Why does `GateError` connect `Community 5` to `Community 8`?**
