...
## Summary
- 1160 nodes · 2395 edges · 59 communities detected
- Extraction: 47% EXTRACTED · 53% INFERRED · 0% AMBIGUOUS · INFERRED: 1279 edges (avg confidence: 0.5)
...
- `compute_entry_hash()` --calls--> `canonical_json()`  [INFERRED]
  /Users/bennibarger/Developer/HLDPRO/hldpro-governance-issue-109-stage-a/scripts/remote-mcp/verify_audit.py → scripts/windows-ollama/verify_audit.py
